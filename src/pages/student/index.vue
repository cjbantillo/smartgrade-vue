  ...
  <v-container class="pa-6" fluid>
    ...
    <v-row>
      <v-col cols="12">
        ...
        <p v-if="studentInfo" class="text-h6 text-medium-emphasis mb-6">
    ...
    <template v-else>
      ...
      <v-row>
        <v-col cols="12" md="4">
          <v-card>
            ...
            <v-card-text v-if="studentInfo" class="pa-4">
              <v-list density="compact">
                <v-list-item>
                  <v-list-item-title class="text-caption text-medium-emphasis">LRN</v-list-item-title>
                ...
                <v-list-item>
                  <v-list-item-title class="text-caption text-medium-emphasis">Grade Level</v-list-item-title>
                  <v-list-item-subtitle class="text-h6">{{
                    studentInfo.grade_level
                  }}</v-list-item-subtitle>
                </v-list-item>
                <v-list-item>
                  <v-list-item-title class="text-caption text-medium-emphasis">Track</v-list-item-title>
                  <v-list-item-subtitle class="text-h6">{{
                    studentInfo.track
                  }}</v-list-item-subtitle>
                </v-list-item>
                <v-list-item>
                  <v-list-item-title class="text-caption text-medium-emphasis">Strand</v-list-item-title>
                  <v-list-item-subtitle class="text-h6">{{
                    studentInfo.strand
                  }}</v-list-item-subtitle>
                </v-list-item>
                <v-list-item v-if="studentInfo.section">
                  <v-list-item-title class="text-caption text-medium-emphasis">Section</v-list-item-title>
                  <v-list-item-subtitle class="text-h6">{{
                    studentInfo.section
                  }}</v-list-item-subtitle>
                </v-list-item>
        ...
        <v-col cols="12" md="4">
          <v-card>
            ...
            <v-card-text v-if="currentGPA" class="pa-6 text-center">
            ...
            <v-card-text class="pa-4">
              <v-list density="compact">
                <v-list-item>
                  ...
                  <v-list-item-subtitle>{{ sf9Count }} available</v-list-item-subtitle>
                </v-list-item>
                <v-list-item>
                  <template #prepend>
                ...
                <v-list-item>
                  ...
                  <v-list-item-subtitle>{{ certificatesCount }} earned</v-list-item-subtitle>
                </v-list-item>
              </v-list>
            </v-card-text>
          </v-card>
      ...
      <v-row class="mt-4">
        ...
        <v-col cols="12" md="3">
          <v-card hover @click="router.push('/student/certificates')">
            <v-card-text class="text-center pa-6">
              <v-icon color="purple" size="64">mdi-certificate</v-icon>
        ...
        <v-col cols="12" md="3">
          <v-card hover @click="router.push('/verify')">
            <v-card-text class="text-center pa-6">
              <v-icon color="info" size="64">mdi-shield-check</v-icon>
      ...
      <!-- GPA History -->
      <v-row v-if="gpaHistory.length > 0" class="mt-4">
        <v-col cols="12">
          <v-card>

...
export function useStudent() {
  ...
  async function getStudentId(): Promise<string | null> {
    try {
      ...
      console.error("Unexpected error getting student ID:", err);
      return null;
    }
  }
  ...
  async function fetchStudentInfo(): Promise<StudentInfo | null> {
    ...
    try {
      ...
      console.error("Unexpected error fetching student info:", err);
  ...
  async function fetchStudentGPA(): Promise<StudentGPA[]> {
    ...
    try {
      ...
      console.error("Unexpected error fetching GPA:", err);
      error.value = "An unexpected error occurred";
      return [];
    } finally {
      loading.value = false;
  ...
  async function getActiveSchoolYear(): Promise<any> {
    try {
      ...
      console.error("Unexpected error fetching active school year:", err);
      return null;
    }
  }
